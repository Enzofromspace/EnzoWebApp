var Qe=Object.defineProperty;var Xe=(o,e,t)=>e in o?Qe(o,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):o[e]=t;var g=(o,e,t)=>Xe(o,typeof e!="symbol"?e+"":e,t);import{r as b,b as Ke,R as _e}from"./react-CHYZsP8B.js";import{m as ee}from"./pixi-YXKqUbkg.js";import{c as Je,s as pe,F as Ve,S as et,n as Ae}from"./tone-BHsarVZ3.js";import{g as U}from"./gsap-DjKJqAo0.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function t(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(s){if(s.ep)return;s.ep=!0;const i=t(s);fetch(s.href,i)}})();var Ne={exports:{}},oe={};/**
 * @license React
...
`+a.raw,c.text+=`
`+a.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=c.text):t.push(a);continue}if(e){const c="Infinite loop on byte: "+e.charCodeAt(0);if(this.options.silent){console.error(c);break}else throw new Error(c)}}return this.state.top=!0,t}inline(e,t=[]){return this.inlineQueue.push({src:e,tokens:t}),t}inlineTokens(e,t=[]){var a,d,c;let n=e,s=null;if(this.tokens.links){const l=Object.keys(this.tokens.links);if(l.length>0)for(;(s=this.tokenizer.rules.inline.reflinkSearch.exec(n))!=null;)l.includes(s[0].slice(s[0].lastIndexOf("[")+1,-1))&&(n=n.slice(0,s.index)+"["+"a".repeat(s[0].length-2)+"]"+n.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(s=this.tokenizer.rules.inline.blockSkip.exec(n))!=null;)n=n.slice(0,s.index)+"["+"a".repeat(s[0].length-2)+"]"+n.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);for(;(s=this.tokenizer.rules.inline.anyPunctuation.exec(n))!=null;)n=n.slice(0,s.index)+"++"+n.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);let i=!1,r="";for(;e;){i||(r=""),i=!1;let l;if((d=(a=this.options.extensions)==null?void 0:a.inline)!=null&&d.some(h=>(l=h.call({lexer:this},e,t))?(e=e.substring(l.raw.length),t.push(l),!0):!1))continue;if(l=this.tokenizer.escape(e)){e=e.substring(l.raw.length),t.push(l);continue}if(l=this.tokenizer.tag(e)){e=e.substring(l.raw.length),t.push(l);continue}if(l=this.tokenizer.link(e)){e=e.substring(l.raw.length),t.push(l);continue}if(l=this.tokenizer.reflink(e,this.tokens.links)){e=e.substring(l.raw.length);const h=t.at(-1);l.type==="text"&&(h==null?void 0:h.type)==="text"?(h.raw+=l.raw,h.text+=l.text):t.push(l);continue}if(l=this.tokenizer.emStrong(e,n,r)){e=e.substring(l.raw.length),t.push(l);continue}if(l=this.tokenizer.codespan(e)){e=e.substring(l.raw.length),t.push(l);continue}if(l=this.tokenizer.br(e)){e=e.substring(l.raw.length),t.push(l);continue}if(l=this.tokenizer.del(e)){e=e.substring(l.raw.length),t.push(l);continue}if(l=this.tokenizer.autolink(e)){e=e.substring(l.raw.length),t.push(l);continue}if(!this.state.inLink&&(l=this.tokenizer.url(e))){e=e.substring(l.raw.length),t.push(l);continue}let u=e;if((c=this.options.extensions)!=null&&c.startInline){let h=1/0;const m=e.slice(1);let w;this.options.extensions.startInline.forEach(x=>{w=x.call({lexer:this},m),typeof w=="number"&&w>=0&&(h=Math.min(h,w))}),h<1/0&&h>=0&&(u=e.substring(0,h+1))}if(l=this.tokenizer.inlineText(u)){e=e.substring(l.raw.length),l.raw.slice(-1)!=="_"&&(r=l.raw.slice(-1)),i=!0;const h=t.at(-1);(h==null?void 0:h.type)==="text"?(h.raw+=l.raw,h.text+=l.text):t.push(l);continue}if(e){const h="Infinite loop on byte: "+e.charCodeAt(0);if(this.options.silent){console.error(h);break}else throw new Error(h)}}return t}}class se{constructor(e){g(this,"options");g(this,"parser");this.options=e||z}space(e){return""}code({text:e,lang:t,escaped:n}){var r;const s=(r=(t||"").match(v.notSpaceStart))==null?void 0:r[0],i=e.replace(v.endingNewline,"")+`
...
`).trim();o.innerHTML=`
    ...
    `,document.body.appendChild(o);const e=o.querySelector(".exit-button"),t=()=>o.remove();e==null||e.addEventListener("click",t),document.addEventListener("keydown",n=>{n.key==="Escape"&&t()})},showSplashReel:()=>{const o=document.createElement("div");o.className="splash-reel-modal",o.innerHTML=`
      <div class="modal-content foundation-theme">
        ...
        <div class="splash-content">
          ...
          <button class="contact-button" onclick="handleExternalLink('https://foundationinc.co/contact/')">
            Contact Foundation
          </button>
        </div>
      </div>
    ...
    `,o.classList.add("tv-animation"),document.body.appendChild(o),await C.initCalendly();const e=o.querySelector(".exit-button"),t=()=>{o.classList.add("tv-off"),setTimeout(()=>o.remove(),500)};e==null||e.addEventListener("click",t),document.addEventListener("keydown",n=>{n.key==="Escape"&&t()})}},Ue={"/lore/upload-protocol.md":Zt,"/lore/synthetic-dreams.md":Yt,"/lore/digital-echoes.md":Qt,"/lore/emergence-theory.md":Xt,"/lore/quantum-cognition.md":Kt,"/lore/memory-fragments.md":Jt,"/lore/silicon-koans.md":Vt,"/lore/binary-zen.md":en,"/lore/digital-enlightenment.md":tn},J=o=>{const e=document.createElement("a");e.href=o,e.target="_blank",e.rel="noopener noreferrer",e.style.display="none",document.body.appendChild(e),requestAnimationFrame(()=>{try{e.click()}catch{try{window.open(o,"_blank","noopener,noreferrer")}catch{window.location.href=o}}finally{setTimeout(()=>{document.body.contains(e)&&document.body.removeChild(e)},300)}})},N={start:{text:"Welcome I am Enzo.ai - Please make a selection from the choices availble.",choices:[{text:"Get to know Enzo",nextNode:"get_to_know"},{text:"Work With Enzo",nextNode:"work_with"},{text:"Kill Some Time",nextNode:"kill_time"}]},get_to_know:{text:"Solid Choice. People have been telling me good things.",choices:[{text:"See Enzo's public bio",nextNode:"get_to_know_end"},{text:"Get Enzo's socials",nextNode:"get_to_know_end2"},{text:"Learn about this project",nextNode:"get_to_know_end3"}]},get_to_know_end:{text:"Launching bio...",callback:()=>{J("https://foundationinc.co/team/enzo-carletti")},isEndNode:!0},get_to_know_end2:{text:"Electronic interdependence recreates the world in the image of a global village.",choices:[{text:`YouTube
🎥
...
`).trim();e.innerHTML=`
  ...
  `,e.classList.add("tv-animation"),document.body.appendChild(e);const s=e.querySelector(".exit-button"),i=e.querySelector(".back-button"),r=()=>{e.classList.add("tv-off"),setTimeout(()=>e.remove(),500)},a=()=>{e.classList.add("tv-off"),setTimeout(()=>{e.remove(),C.showDeepLore()},500)};s==null||s.addEventListener("click",r),i==null||i.addEventListener("click",a),document.addEventListener("keydown",d=>{d.key==="Escape"&&r()})},V=()=>_.getInstance().getCurrentText(),W=()=>_.getInstance().getCurrentChoices(),on=o=>_.getInstance().makeChoice(o),rn=()=>_.getInstance().handleEasterEggClick(),an=()=>_.getInstance().resetToHome(),ln=()=>_.getInstance().navigateBack(),cn=()=>_.getInstance().navigateForward(),dn=()=>{const[o,e]=b.useState(V()),[t,n]=b.useState(V()),[s,i]=b.useState(!0),r=b.useRef(null),a=b.useRef(),d=50,c=b.useCallback(u=>{a.current&&clearTimeout(a.current),i(!0),e("");let h=0;const m=async()=>{var w;h<=u.length?(e(u.slice(0,h)),h<u.length&&((w=u[h])!=null&&w.trim())&&await lt(),h++,a.current=setTimeout(m,d)):(i(!1),window.dispatchEvent(new CustomEvent("text-animation-complete")))};m()},[]);b.useEffect(()=>{const u=h=>{var w;const m=V();n(m),(w=h.detail)!=null&&w.skipAnimation?(e(m),i(!1),window.dispatchEvent(new CustomEvent("text-animation-complete"))):(r.current&&U.fromTo(r.current,{opacity:0,y:30},{opacity:1,y:0,duration:.5}),c(m))};return e(V()),window.addEventListener("dialogue-update",u),()=>{window.removeEventListener("dialogue-update",u),a.current&&clearTimeout(a.current)}},[c]);const l=()=>{s?(a.current&&clearTimeout(a.current),e(t),i(!1),window.dispatchEvent(new CustomEvent("text-animation-complete"))):(t.includes("🎮")||t.includes("🔓")||t.includes("🎯"))&&(rn(),r.current&&U.fromTo(r.current,{scale:1},{scale:1.05,duration:.2,yoyo:!0,repeat:1,ease:"power2.out"}))};return t?y.jsxs("div",{ref:r,className:`dialogue-box ${s?"clickable":""} ${t.includes("🎮")||t.includes("🔓")||t.includes("🎯")?"easter-egg":""}`,onClick:l,style:{cursor:s||t.includes("🎮")||t.includes("🔓")||t.includes("🎯")?"pointer":"default"},children:[y.jsx("div",{className:"dialogue-tail"}),o]}):null},un=({text:o,onClick:e,socialLink:t})=>{const n=c=>{if(!c.includes(`
...
`),d=o.includes(`
`);return y.jsx("button",{className:`choice-box ${d?"social-choice":""}`,onClick:s,onTouchStart:()=>{},style:n(o),children:d?y.jsxs(y.Fragment,{children:[y.jsx("div",{className:"social-title",children:i}),y.jsx("div",{className:"social-icon",children:r}),y.jsx("div",{className:"social-description",children:a})]}):o})},hn=()=>{const[o,e]=b.useState(()=>typeof window<"u"?window.innerWidth<=768:!1),[t,n]=b.useState(!1),s="/EnzoWebApp/assets/images/character.png",i={x:o?window.innerWidth*.5:window.innerWidth*.15,y:o?window.innerHeight*.5:window.innerHeight*.85};return b.useEffect(()=>{const r=()=>{e(window.innerWidth<=768),window.dispatchEvent(new CustomEvent("character-move",{detail:{x:window.innerWidth*.15,y:window.innerWidth<=768?window.innerHeight*.45:window.innerHeight*.85}}))};e(window.innerWidth<=768),window.addEventListener("resize",r);const a=new Image;return a.src=s,a.onload=()=>n(!0),()=>{window.removeEventListener("resize",r)}},[]),t?y.jsx(ee.Container,{children:y.jsx(ee.Sprite,{image:s,x:i.x,y:i.y,anchor:{x:.5,y:1},scale:o?.4:.5})}):null},pn=()=>{const[o,e]=b.useState(!1),t="/EnzoWebApp/assets/images/background.png";return b.useEffect(()=>{const n=new Image;n.src=t,n.onload=()=>e(!0)},[]),o?y.jsx(ee.Sprite,{image:t,width:window.innerWidth,height:window.innerHeight,x:0,y:0}):null},mn=()=>{const[o,e]=b.useState(()=>W()),[t,n]=b.useState(null),[s,i]=b.useState({width:window.innerWidth,height:window.innerHeight});b.useEffect(()=>{const l=()=>{i({width:window.innerWidth,height:window.innerHeight})};return window.addEventListener("resize",l),()=>window.removeEventListener("resize",l)},[]),b.useEffect(()=>{(async()=>{try{await re();const u=document.querySelector(".dialogue-box"),h=document.querySelector(".choices-container");u&&u.classList.add("visible"),h&&h.classList.add("visible"),U.fromTo([".dialogue-box",".choices-container"],{opacity:0,y:20},{opacity:1,y:0,duration:.5,stagger:.2,ease:"power2.out"})}catch(u){console.error("Initialization error:",u),n("Failed to initialize game components")}})()},[]);const r=l=>{try{U.to(".choices-container",{opacity:0,duration:.3,onComplete:()=>{on(l),e(W()),U.to(".choices-container",{opacity:1,duration:.3})}})}catch(u){console.error("Choice handling error:",u),n("Failed to process choice")}},a=()=>{an(),e(W())},d=()=>{try{ln(),e(W())}catch(l){console.error("Navigation error:",l)}},c=()=>{try{cn(),e(W())}catch(l){console.error("Navigation error:",l)}};return t?y.jsx("div",{className:"error-message",children:t}):y.jsxs("div",{className:"game-container",children:[y.jsxs(ee.Stage,{width:s.width,height:s.height,options:{backgroundColor:0,antialias:!0,resolution:window.devicePixelRatio||1,autoDensity:!0},children:[y.jsx(pn,{}),y.jsx(hn,{})]}),y.jsx(dn,{}),y.jsxs("div",{className:"choices-container",children:[o.map((l,u)=>y.jsx(un,{text:l.text,onClick:()=>r(u),socialLink:l.socialLink},u)),y.jsxs("div",{className:"navigation-buttons",children:[y.jsx("button",{className:"nav-button back",onClick:d,children:"⬅️"}),y.jsx("button",{className:"home-button",onClick:a,children:"🏠"}),y.jsx("button",{className:"nav-button forward",onClick:c,children:"➡️"})]})]})]})};function gn(){return b.useEffect(()=>{(async()=>{await re()})().catch(console.error)},[]),y.jsx("div",{className:"app",children:y.jsx(mn,{})})}window.React=_e;ue.createRoot(document.getElementById("root")).render(y.jsx(_e.StrictMode,{children:y.jsx(gn,{})}));
//# sourceMappingURL=main-grirvLWr.js.map
