var Qe=Object.defineProperty;var Xe=(o,e,t)=>e in o?Qe(o,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):o[e]=t;var g=(o,e,t)=>Xe(o,typeof e!="symbol"?e+"":e,t);import{r as b,b as Ke,R as _e}from"./react-CHYZsP8B.js";import{m as V}from"./pixi-B3dTp2-f.js";import{c as Je,s as pe,F as Ve,S as et,n as Ae}from"./tone-BHsarVZ3.js";import{g as U}from"./gsap-DjKJqAo0.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function t(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(s){if(s.ep)return;s.ep=!0;const i=t(s);fetch(s.href,i)}})();var Ne={exports:{}},se={};/**
 * @license React
...
**Buy me a coffee** > https://buy.stripe.com/7sIeW47fXgGn2BidQQ`;f.setOptions({breaks:!0,gfm:!0});const C={work_with_end:()=>{const o=document.createElement("div");o.className="form-modal",o.innerHTML=`
    ...
    `,document.body.appendChild(o);const e=o.querySelector(".close-button");e==null||e.addEventListener("click",()=>{o.remove(),_.getInstance().setNode("kill_time")}),ct()},get_to_know_end3:()=>{const o=document.createElement("div");o.className="project-details-modal";const e=Ft.replace(/\\n/g,`
`);o.innerHTML=`
...
`).trim();o.innerHTML=`
    ...
    `,o.classList.add("tv-animation"),document.body.appendChild(o),await C.initCalendly();const e=o.querySelector(".exit-button"),t=()=>{o.classList.add("tv-off"),setTimeout(()=>o.remove(),500)};e==null||e.addEventListener("click",t),document.addEventListener("keydown",n=>{n.key==="Escape"&&t()})}},Ue={"/lore/upload-protocol.md":Zt,"/lore/synthetic-dreams.md":Yt,"/lore/digital-echoes.md":Qt,"/lore/emergence-theory.md":Xt,"/lore/quantum-cognition.md":Kt,"/lore/memory-fragments.md":Jt,"/lore/silicon-koans.md":Vt,"/lore/binary-zen.md":en,"/lore/digital-enlightenment.md":tn},N={start:{text:"Welcome I am Enzo.ai - Please make a selection from the choices availble.",choices:[{text:"Get to know Enzo",nextNode:"get_to_know"},{text:"Work With Enzo",nextNode:"work_with"},{text:"Kill Some Time",nextNode:"kill_time"}]},get_to_know:{text:"Solid Choice. People have been telling me good things.",choices:[{text:"See Enzo's public bio",nextNode:"get_to_know_end"},{text:"Get Enzo's socials",nextNode:"get_to_know_end2"},{text:"Learn about this project",nextNode:"get_to_know_end3"}]},get_to_know_end:{text:"Launching bio...",callback:()=>{de("https://foundationinc.co/team/enzo-carletti")},isEndNode:!0},get_to_know_end2:{text:"Electronic interdependence recreates the world in the image of a global village.",choices:[{text:`YouTube
🎥
...
`).trim();e.innerHTML=`
  ...
  `,e.classList.add("tv-animation"),document.body.appendChild(e);const s=e.querySelector(".exit-button"),i=e.querySelector(".back-button"),r=()=>{e.classList.add("tv-off"),setTimeout(()=>e.remove(),500)},a=()=>{e.classList.add("tv-off"),setTimeout(()=>{e.remove(),C.showDeepLore()},500)};s==null||s.addEventListener("click",r),i==null||i.addEventListener("click",a),document.addEventListener("keydown",d=>{d.key==="Escape"&&r()})},J=()=>_.getInstance().getCurrentText(),F=()=>_.getInstance().getCurrentChoices(),on=o=>_.getInstance().makeChoice(o),rn=()=>_.getInstance().handleEasterEggClick(),an=()=>_.getInstance().resetToHome(),ln=()=>_.getInstance().navigateBack(),cn=()=>_.getInstance().navigateForward(),de=o=>{window.open(o,"_blank","noopener,noreferrer")},dn=()=>{const[o,e]=b.useState(J()),[t,n]=b.useState(J()),[s,i]=b.useState(!0),r=b.useRef(null),a=b.useRef(),d=50,c=b.useCallback(u=>{a.current&&clearTimeout(a.current),i(!0),e("");let h=0;const m=async()=>{var w;h<=u.length?(e(u.slice(0,h)),h<u.length&&((w=u[h])!=null&&w.trim())&&await lt(),h++,a.current=setTimeout(m,d)):(i(!1),window.dispatchEvent(new CustomEvent("text-animation-complete")))};m()},[]);b.useEffect(()=>{const u=h=>{var w;const m=J();n(m),(w=h.detail)!=null&&w.skipAnimation?(e(m),i(!1),window.dispatchEvent(new CustomEvent("text-animation-complete"))):(r.current&&U.fromTo(r.current,{opacity:0,y:30},{opacity:1,y:0,duration:.5}),c(m))};return e(J()),window.addEventListener("dialogue-update",u),()=>{window.removeEventListener("dialogue-update",u),a.current&&clearTimeout(a.current)}},[c]);const l=()=>{s?(a.current&&clearTimeout(a.current),e(t),i(!1),window.dispatchEvent(new CustomEvent("text-animation-complete"))):(t.includes("🎮")||t.includes("🔓")||t.includes("🎯"))&&(rn(),r.current&&U.fromTo(r.current,{scale:1},{scale:1.05,duration:.2,yoyo:!0,repeat:1,ease:"power2.out"}))};return t?y.jsxs("div",{ref:r,className:`dialogue-box ${s?"clickable":""} ${t.includes("🎮")||t.includes("🔓")||t.includes("🎯")?"easter-egg":""}`,onClick:l,style:{cursor:s||t.includes("🎮")||t.includes("🔓")||t.includes("🎯")?"pointer":"default"},children:[y.jsx("div",{className:"dialogue-tail"}),o]}):null},un=({text:o,onClick:e,socialLink:t})=>{const n=c=>{if(!c.includes(`
`))return{};const l=c.split(`
`)[0].toLowerCase();return{youtube:{background:"rgba(255, 0, 0, 0.9)",color:"white"},linkedin:{background:"rgba(0, 119, 181, 0.9)",color:"white"},twitch:{background:"rgba(145, 70, 255, 0.9)",color:"white"},twitter:{background:"rgba(29, 161, 242, 0.9)",color:"white"},tiktok:{background:"linear-gradient(45deg, #00f2ea, #ff0050)",color:"white"}}[l]||{}},s=async c=>{c.preventDefault(),setTimeout(async()=>{try{await Pe(),t&&(window.innerWidth<=768?window.location.href=t:window.open(t,"_blank")),e()}catch(l){console.error("Error playing choice sound:",l),t&&(window.location.href=t),e()}},50)},[i,r,a]=o.split(`
`),d=o.includes(`
`);return y.jsx("button",{className:`choice-box ${d?"social-choice":""}`,onClick:s,onTouchStart:()=>{},style:n(o),children:d?y.jsxs(y.Fragment,{children:[y.jsx("div",{className:"social-title",children:i}),y.jsx("div",{className:"social-icon",children:r}),y.jsx("div",{className:"social-description",children:a})]}):o})},hn=()=>{const[o,e]=b.useState(()=>typeof window<"u"?window.innerWidth<=768:!1),[t,n]=b.useState(!1),s="/EnzoWebApp/assets/images/character.png",i={x:o?window.innerWidth*.5:window.innerWidth*.15,y:o?window.innerHeight*.5:window.innerHeight*.85};return b.useEffect(()=>{const r=()=>{e(window.innerWidth<=768),window.dispatchEvent(new CustomEvent("character-move",{detail:{x:window.innerWidth*.15,y:window.innerWidth<=768?window.innerHeight*.45:window.innerHeight*.85}}))};e(window.innerWidth<=768),window.addEventListener("resize",r);const a=new Image;return a.src=s,a.onload=()=>n(!0),()=>{window.removeEventListener("resize",r)}},[]),t?y.jsx(V.Container,{children:y.jsx(V.Sprite,{image:s,x:i.x,y:i.y,anchor:{x:.5,y:1},scale:o?.4:.5})}):null},pn=()=>{const[o,e]=b.useState(!1),t="/EnzoWebApp/assets/images/background.png";return b.useEffect(()=>{const n=new Image;n.src=t,n.onload=()=>e(!0)},[]),o?y.jsx(V.Sprite,{image:t,width:window.innerWidth,height:window.innerHeight,x:0,y:0}):null},mn=()=>{const[o,e]=b.useState(()=>F()),[t,n]=b.useState(null),[s,i]=b.useState({width:window.innerWidth,height:window.innerHeight});b.useEffect(()=>{const l=()=>{i({width:window.innerWidth,height:window.innerHeight})};return window.addEventListener("resize",l),()=>window.removeEventListener("resize",l)},[]),b.useEffect(()=>{(async()=>{try{await oe();const u=document.querySelector(".dialogue-box"),h=document.querySelector(".choices-container");u&&u.classList.add("visible"),h&&h.classList.add("visible"),U.fromTo([".dialogue-box",".choices-container"],{opacity:0,y:20},{opacity:1,y:0,duration:.5,stagger:.2,ease:"power2.out"})}catch(u){console.error("Initialization error:",u),n("Failed to initialize game components")}})()},[]);const r=l=>{try{U.to(".choices-container",{opacity:0,duration:.3,onComplete:()=>{on(l),e(F()),U.to(".choices-container",{opacity:1,duration:.3})}})}catch(u){console.error("Choice handling error:",u),n("Failed to process choice")}},a=()=>{an(),e(F())},d=()=>{try{ln(),e(F())}catch(l){console.error("Navigation error:",l)}},c=()=>{try{cn(),e(F())}catch(l){console.error("Navigation error:",l)}};return t?y.jsx("div",{className:"error-message",children:t}):y.jsxs("div",{className:"game-container",children:[y.jsxs(V.Stage,{width:s.width,height:s.height,options:{backgroundColor:0,antialias:!0,resolution:window.devicePixelRatio||1,autoDensity:!0},children:[y.jsx(pn,{}),y.jsx(hn,{})]}),y.jsx(dn,{}),y.jsxs("div",{className:"choices-container",children:[o.map((l,u)=>y.jsx(un,{text:l.text,onClick:()=>r(u),socialLink:l.socialLink},u)),y.jsxs("div",{className:"navigation-buttons",children:[y.jsx("button",{className:"nav-button back",onClick:d,children:"⬅️"}),y.jsx("button",{className:"home-button",onClick:a,children:"🏠"}),y.jsx("button",{className:"nav-button forward",onClick:c,children:"➡️"})]})]})]})};function gn(){return b.useEffect(()=>{(async()=>{await oe()})().catch(console.error)},[]),y.jsx("div",{className:"app",children:y.jsx(mn,{})})}window.React=_e;ue.createRoot(document.getElementById("root")).render(y.jsx(_e.StrictMode,{children:y.jsx(gn,{})}));
//# sourceMappingURL=main-5mR_lV6_.js.map
