var Be=Object.defineProperty;var He=(o,e,t)=>e in o?Be(o,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):o[e]=t;var g=(o,e,t)=>He(o,typeof e!="symbol"?e+"":e,t);import{r as b,b as Ge,R as Te}from"./react-CHYZsP8B.js";import{m as K}from"./pixi-B3dTp2-f.js";import{c as Fe,s as ce,F as We,S as Ue,n as Se}from"./tone-BHsarVZ3.js";import{g as G}from"./gsap-DjKJqAo0.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function t(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(s){if(s.ep)return;s.ep=!0;const i=t(s);fetch(s.href,i)}})();var Ce={exports:{}},ne={};/**
 * @license React
...
`);o.innerHTML=`
    ...
    `,document.body.appendChild(o);const t=o.querySelector(".exit-button"),n=()=>o.remove();t==null||t.addEventListener("click",n);const s=i=>{i.key==="Escape"&&(n(),document.removeEventListener("keydown",s))};document.addEventListener("keydown",s)},showPasscodeModal:()=>{var s;const o=document.createElement("div");o.className="passcode-modal",o.innerHTML=`
      <div class="modal-content retro-terminal">
        ...
        <div class="passcode-content">
          <img src="/EnzoWebApp/images/giphy.gif" class="dialogue-gif" alt="passcode required" />
        </div>
      </div>
