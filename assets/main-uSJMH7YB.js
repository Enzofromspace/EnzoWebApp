...
`)[0].toLowerCase();return{youtube:{background:"rgba(255, 0, 0, 0.9)",color:"white"},linkedin:{background:"rgba(0, 119, 181, 0.9)",color:"white"},twitch:{background:"rgba(145, 70, 255, 0.9)",color:"white"},twitter:{background:"rgba(29, 161, 242, 0.9)",color:"white"},tiktok:{background:"linear-gradient(45deg, #00f2ea, #ff0050)",color:"white"}}[l]||{}},s=async c=>{c.preventDefault(),setTimeout(async()=>{try{await $e(),t&&window.open(t,"_blank"),e()}catch(l){console.error("Error playing choice sound:",l),e()}},50)},[i,r,a]=o.split(`
`),d=o.includes(`
...
//# sourceMappingURL=main-uSJMH7YB.js.map
