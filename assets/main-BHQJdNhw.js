var Qe=Object.defineProperty;var Xe=(o,e,t)=>e in o?Qe(o,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):o[e]=t;var g=(o,e,t)=>Xe(o,typeof e!="symbol"?e+"":e,t);import{r as y,b as Ke,R as _e}from"./react-CHYZsP8B.js";import{m as ee}from"./pixi-B3dTp2-f.js";import{c as Je,s as pe,F as Ve,S as et,n as Ae}from"./tone-BHsarVZ3.js";import{g as Z}from"./gsap-DjKJqAo0.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function t(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(s){if(s.ep)return;s.ep=!0;const i=t(s);fetch(s.href,i)}})();var Ne={exports:{}},oe={};/**
 * @license React
...
`).trim();o.innerHTML=`
  ...
  `,(i=t.querySelector(".button-container"))==null||i.appendChild(e),document.body.appendChild(t),e.addEventListener("click",()=>{window.open(o,"_blank","noopener,noreferrer"),t.remove()});const n=t.querySelector(".exit-button"),s=()=>{t.remove()};n==null||n.addEventListener("click",s),document.addEventListener("keydown",r=>{r.key==="Escape"&&s()})},N={start:{text:"Welcome I am Enzo.ai - Please make a selection from the choices availble.",choices:[{text:"Get to know Enzo",nextNode:"get_to_know"},{text:"Work With Enzo",nextNode:"work_with"},{text:"Kill Some Time",nextNode:"kill_time"}]},get_to_know:{text:"Solid Choice. People have been telling me good things.",choices:[{text:"See Enzo's public bio",nextNode:"get_to_know_end"},{text:"Get Enzo's socials",nextNode:"get_to_know_end2"},{text:"Learn about this project",nextNode:"get_to_know_end3"}]},get_to_know_end:{text:"Launching bio...",callback:()=>M("https://foundationinc.co/team/enzo-carletti"),isEndNode:!0},get_to_know_end2:{text:"ily",callback:()=>{const o=document.createElement("div");o.className="splash-reel-modal",o.innerHTML=`
        <div class="modal-content foundation-theme">
          <div class="modal-header">
            <span class="exit-button">EXIT</span>
          </div>
...
//# sourceMappingURL=main-BHQJdNhw.js.map
