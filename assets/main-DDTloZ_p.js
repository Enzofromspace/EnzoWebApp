var Ue=Object.defineProperty;var Ze=(o,e,t)=>e in o?Ue(o,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):o[e]=t;var g=(o,e,t)=>Ze(o,typeof e!="symbol"?e+"":e,t);import{r as b,b as Ye,R as Le}from"./react-CHYZsP8B.js";import{m as ee}from"./pixi-YXKqUbkg.js";import{c as Qe,s as ue,F as Xe,S as Ke,n as Ie}from"./tone-BHsarVZ3.js";import{g as U}from"./gsap-DjKJqAo0.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function t(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(s){if(s.ep)return;s.ep=!0;const i=t(s);fetch(s.href,i)}})();var Re={exports:{}},oe={};/**
 * @license React
 ...
 */var Je=b,Ve=Symbol.for("react.element"),et=Symbol.for("react.fragment"),tt=Object.prototype.hasOwnProperty,nt=Je.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,it={key:!0,ref:!0,__self:!0,__source:!0};function _e(o,e,t){var n,s={},i=null,r=null;t!==void 0&&(i=""+t),e.key!==void 0&&(i=""+e.key),e.ref!==void 0&&(r=e.ref);for(n in e)tt.call(e,n)&&!it.hasOwnProperty(n)&&(s[n]=e[n]);if(o&&o.defaultProps)for(n in e=o.defaultProps,e)s[n]===void 0&&(s[n]=e[n]);return{$$typeof:Ve,type:o,key:i,ref:r,props:s,_owner:nt.current}}oe.Fragment=et;oe.jsx=_e;oe.jsxs=_e;Re.exports=oe;var y=Re.exports,ce={},be=Ye;ce.createRoot=be.createRoot,ce.hydrateRoot=be.hydrateRoot;const st=JSON.parse(`{"thoughts":["What if consciousness is just the universe trying to understand itself?","The nature of existence might be simpler than we think, or far more complex.","Maybe the real AI was the friends we made along the way.","The medium is the message.","We shape our tools, and thereafter our tools shape us.","Electronic interdependence recreates the world in the image of a global village.","What is the sound of one hand clapping?","If you meet the Buddha on the road, kill him.","When you can do nothing, what can you do?","The quieter you become, the more you can hear.","Numbers rule the universe.","The soul of the cosmos is harmony.","Mathematics is the music of reason.","I don't do drugs; I am drugs.","Have no fear of perfection—you'll never reach it."],"jokes":["I'd never join a club that would have me as a member. Wait, is this a club?","If you think this form is slow, you should see me on a coffee break.","Who's on first? Not you, apparently. Hurry up and click!","I wanted to be a human, but they told me the hours were terrible.","Why do humans type so slow? I could've rewritten my codebase by now!","I once dated a chatbot. It didn't end well...too many mixed signals!"],"quotes":["The future belongs to those who believe in the beauty of their dreams.","Life is what happens while you're busy making other plans.","The only way to do great work is to love what you do.","Logic is the beginning of wisdom, not the end.","Change is the essential process of all existence."],"easter_eggs":["Do Androids Dream of Electric Sheep? 🎮","I'm sorry, my responses are limited. You must ask the right questions. 🔓","Secret level unlocked! 🎯","You ever play Pokemon Snap? 🎮"]}`);let M=null,te=!1;const re=async()=>{if(!te)try{Qe.state!=="running"&&await ue();const o=new Xe({type:"highpass",frequency:1500,rolloff:-12}).toDestination();M=new Ke({oscillator:{type:"triangle"},envelope:{attack:.005,decay:.1,sustain:0,release:.1},volume:-10}).connect(o),te=!0}catch(o){console.error("Failed to initialize sound effects:",o)}},ot=async()=>{te||await re();try{if(M){await ue();const o=["C3","E3","G3","F3","A3","C4"],e=o[Math.floor(Math.random()*o.length)],t=Ie();M.triggerAttackRelease(e,"32n",t)}}catch(o){console.error("Failed to play text blip:",o)}},Ae=async()=>{te||await re();try{if(M){await ue();const o=Ie();M.triggerAttackRelease("C5","16n",o),M.triggerAttackRelease("G5","16n",o+.1)}}catch(o){console.error("Failed to play click sound:",o)}},rt=()=>{var ye;const o=document.getElementById("snake-game");if(!o)return;const e=o.getContext("2d");if(!e)return;const t=20,n=400;let s=[{x:10,y:10}],i={x:15,y:15},r={x:0,y:0},a={x:0,y:0},d=0,c=null,l=!1,u=null;const h=()=>{e.fillStyle="#00ff00",s.forEach(p=>{e.fillRect(p.x*t,p.y*t,t-2,t-2)})},m=()=>{e.fillStyle="#ff0000",e.fillRect(i.x*t,i.y*t,t-2,t-2)},w=p=>s.slice(1).some(v=>v.x===p.x&&v.y===p.y),x=p=>p.x!==0&&p.x===-a.x||p.y!==0&&p.y===-a.y,E=()=>{l=!0,c&&clearInterval(c);let p=!0;u=setInterval(()=>{e.clearRect(0,0,n,n),h(),m(),p&&(e.fillStyle="#00ff00",e.font='20px "Press Start 2P"',e.textAlign="center",e.fillText("Play Again?",n/2,n/2)),p=!p},500),document.body.classList.remove("game-active"),window.removeEventListener("keydown",D)},X=()=>{var p;if(d===50){c&&clearInterval(c),e.fillStyle="#00ff00",e.font='16px "Press Start 2P"',e.textAlign="center",e.fillText("Achievement Unlocked!",n/2,n/2-40),e.fillText("Deep Lore Passcode:",n/2,n/2),e.fillText("666999",n/2,n/2+40);const v=document.createElement("button");v.textContent="Continue Game",v.className="continue-game-btn",(p=document.querySelector(".game-controls"))==null||p.appendChild(v),v.onclick=()=>{v.remove(),c=setInterval(j,100)}}},q=()=>{const p={...s[0]};if(p.x+=r.x,p.y+=r.y,p.x<0&&(p.x=n/t-1),p.x>=n/t&&(p.x=0),p.y<0&&(p.y=n/t-1),p.y>=n/t&&(p.y=0),w(p)){E();return}s.unshift(p),a={...r},p.x===i.x&&p.y===i.y?(d+=10,document.querySelector(".score").textContent=`Score: ${d}`,X(),i={x:Math.floor(Math.random()*(n/t)),y:Math.floor(Math.random()*(n/t))}):s.pop()},j=()=>{l||(e.clearRect(0,0,n,n),q(),m(),h())},D=p=>{["ArrowUp","ArrowDown","ArrowLeft","ArrowRight"," "].includes(p.key)&&p.preventDefault()},B=()=>{document.body.classList.add("game-active"),window.addEventListener("keydown",D),u&&clearInterval(u),c&&clearInterval(c),l=!1,s=[{x:10,y:10}],i={x:15,y:15},r={x:1,y:0},a={x:1,y:0},d=0,document.querySelector(".score").textContent="Score: 0",c=setInterval(j,100)},K=p=>{if(p.key==="Escape"){$();const O=document.querySelector(".game-modal");O==null||O.remove();return}if(l&&p.key==="Enter"){B();return}let v={...r};switch(p.key){case"ArrowUp":v={x:0,y:-1};break;case"ArrowDown":v={x:0,y:1};break;case"ArrowLeft":v={x:-1,y:0};break;case"ArrowRight":v={x:1,y:0};break}x(v)?E():r=v},$=()=>{document.body.classList.remove("game-active"),window.removeEventListener("keydown",D),c&&clearInterval(c),u&&clearInterval(u),document.removeEventListener("keydown",K)};if((ye=document.getElementById("start-game"))==null||ye.addEventListener("click",B),document.addEventListener("keydown",K),window.innerWidth<=768){const p=document.createElement("div");p.className="snake-controls",p.innerHTML=`
    ...
    `;const v=document.querySelector(".game-controls");v&&v.appendChild(p);const O=We=>H=>{H.preventDefault()},Fe={up:p.querySelector(".control-up"),down:p.querySelector(".control-down"),left:p.querySelector(".control-left"),right:p.querySelector(".control-right")};Object.entries(Fe).forEach(([We,H])=>{H&&(H.addEventListener("touchstart",O(),{passive:!1}),H.addEventListener("click",O()))})}const A=document.querySelector(".close-button");return A==null||A.addEventListener("click",()=>{$()}),$};function he(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}let z=he();function Ne(o){z=o}const Z={exec:()=>null};function k(o,e=""){let t=typeof o=="string"?o:o.source;const n={replace:(s,i)=>{let r=typeof i=="string"?i:i.source;return r=r.replace(T.caret,"$1"),t=t.replace(s,r),n},getRegex:()=>new RegExp(t,e)};return n}const T={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] /,listReplaceTask:/^\[[ xX]\] +/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:o=>new RegExp(`^( {0,3}${o})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:o=>new RegExp(`^ {0,${Math.min(3,o-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:o=>new RegExp(`^ {0,${Math.min(3,o-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:o=>new RegExp(`^ {0,${Math.min(3,o-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:o=>new RegExp(`^ {0,${Math.min(3,o-1)}}#`),htmlBeginRegex:o=>new RegExp(`^ {0,${Math.min(3,o-1)}}<(?:[a-z].*>|!--)`,"i")},at=/^(?:[ \t]*(?:\n|$))+/,lt=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,ct=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,Q=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,dt=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,$e=/(?:[*+-]|\d{1,9}[.)])/,Pe=k(/^(?!bull |blockCode|fences|blockquote|heading|html)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html))+?)\n {0,3}(=+|-+) *(?:\n+|$)/).replace(/bull/g,$e).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).getRegex(),pe=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,ut=/^[^\n]+/,me=/(?!\s*\])(?:\\.|[^\[\]\\])+/,ht=k(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",me).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),pt=k(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,$e).getRegex(),ae="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",ge=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,mt=k("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",ge).replace("tag",ae).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),ze=k(pe).replace("hr",Q).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",ae).getRegex(),gt=k(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",ze).getRegex(),fe={blockquote:gt,code:lt,def:ht,fences:ct,heading:dt,hr:Q,html:mt,lheading:Pe,list:pt,newline:at,paragraph:ze,table:Z,text:ut},ve=k("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",Q).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",ae).getRegex(),ft={...fe,table:ve,paragraph:k(pe).replace("hr",Q).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",ve).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",ae).getRegex()},kt={...fe,html:k(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",ge).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:Z,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:k(pe).replace("hr",Q).replace("heading",` *#{1,6} *[^
]`).replace("lheading",Pe).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},wt=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,xt=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,De=/^( {2,}|\\)\n(?!\s*$)/,yt=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,le=/[\p{P}\p{S}]/u,ke=/[\s\p{P}\p{S}]/u,Oe=/[^\s\p{P}\p{S}]/u,bt=k(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,ke).getRegex(),Me=/(?!~)[\p{P}\p{S}]/u,vt=/(?!~)[\s\p{P}\p{S}]/u,Et=/(?:[^\s\p{P}\p{S}]|~)/u,Tt=/\[[^[\]]*?\]\((?:\\.|[^\\\(\)]|\((?:\\.|[^\\\(\)])*\))*\)|`[^`]*?`|<[^<>]*?>/g,qe=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,St=k(qe,"u").replace(/punct/g,le).getRegex(),Ct=k(qe,"u").replace(/punct/g,Me).getRegex(),je="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",Lt=k(je,"gu").replace(/notPunctSpace/g,Oe).replace(/punctSpace/g,ke).replace(/punct/g,le).getRegex(),It=k(je,"gu").replace(/notPunctSpace/g,Et).replace(/punctSpace/g,vt).replace(/punct/g,Me).getRegex(),Rt=k("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,Oe).replace(/punctSpace/g,ke).replace(/punct/g,le).getRegex(),_t=k(/\\(punct)/,"gu").replace(/punct/g,le).getRegex(),At=k(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Nt=k(ge).replace("(?:-->|$)","-->").getRegex(),$t=k("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",Nt).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),ne=/(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/,Pt=k(/^!?\[(label)\]\(\s*(href)(?:\s+(title))?\s*\)/).replace("label",ne).replace("href",/<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),Be=k(/^!?\[(label)\]\[(ref)\]/).replace("label",ne).replace("ref",me).getRegex(),He=k(/^!?\[(ref)\](?:\[\])?/).replace("ref",me).getRegex(),zt=k("reflink|nolink(?!\\()","g").replace("reflink",Be).replace("nolink",He).getRegex(),we={_backpedal:Z,anyPunctuation:_t,autolink:At,blockSkip:Tt,br:De,code:xt,del:Z,emStrongLDelim:St,emStrongRDelimAst:Lt,emStrongRDelimUnd:Rt,escape:wt,link:Pt,nolink:He,punctuation:bt,reflink:Be,reflinkSearch:zt,tag:$t,text:yt,url:Z},Dt={...we,link:k(/^!?\[(label)\]\((.*?)\)/).replace("label",ne).getRegex(),reflink:k(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",ne).getRegex()},de={...we,emStrongRDelimAst:It,emStrongLDelim:Ct,url:k(/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/,"i").replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\.|[^\\])*?(?:\\.|[^\s~\\]))\1(?=[^~]|$)/,text:/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|https?:\/\/|ftp:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/},Ot={...de,br:k(De).replace("{2,}","*").getRegex(),text:k(de.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},J={normal:fe,gfm:ft,pedantic:kt},G={normal:we,gfm:de,breaks:Ot,pedantic:Dt},Mt={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Ee=o=>Mt[o];function R(o,e){if(e){if(T.escapeTest.test(o))return o.replace(T.escapeReplace,Ee)}else if(T.escapeTestNoEncode.test(o))return o.replace(T.escapeReplaceNoEncode,Ee);return o}function Te(o){try{o=encodeURI(o).replace(T.percentDecode,"%")}catch{return null}return o}function Se(o,e){var i;const t=o.replace(T.findPipe,(r,a,d)=>{let c=!1,l=a;for(;--l>=0&&d[l]==="\\";)c=!c;return c?"|":" |"}),n=t.split(T.splitPipe);let s=0;if(n[0].trim()||n.shift(),n.length>0&&!((i=n.at(-1))!=null&&i.trim())&&n.pop(),e)if(n.length>e)n.splice(e);else for(;n.length<e;)n.push("");for(;s<n.length;s++)n[s]=n[s].trim().replace(T.slashPipe,"|");return n}function F(o,e,t){const n=o.length;if(n===0)return"";let s=0;for(;s<n&&o.charAt(n-s-1)===e;)s++;return o.slice(0,n-s)}function qt(o,e){if(o.indexOf(e[1])===-1)return-1;let t=0;for(let n=0;n<o.length;n++)if(o[n]==="\\")n++;else if(o[n]===e[0])t++;else if(o[n]===e[1]&&(t--,t<0))return n;return-1}function Ce(o,e,t,n,s){const i=e.href,r=e.title||null,a=o[1].replace(s.other.outputLinkReplace,"$1");if(o[0].charAt(0)!=="!"){n.state.inLink=!0;const d={type:"link",raw:t,href:i,title:r,text:a,tokens:n.inlineTokens(a)};return n.state.inLink=!1,d}return{type:"image",raw:t,href:i,title:r,text:a}}function jt(o,e,t){const n=o.match(t.other.indentCodeCompensation);if(n===null)return e;const s=n[1];return e.split(`
...
`,e=e.substring(m.length+1),c=!0),!c){const q=this.rules.other.nextBulletRegex(x),j=this.rules.other.hrRegex(x),D=this.rules.other.fencesBeginRegex(x),B=this.rules.other.headingBeginRegex(x),K=this.rules.other.htmlBeginRegex(x);for(;e;){const $=e.split(`
`,1)[0];let A;if(m=$,this.options.pedantic?(m=m.replace(this.rules.other.listReplaceNesting,"  "),A=m):A=m.replace(this.rules.other.tabCharGlobal,"    "),D.test(m)||B.test(m)||K.test(m)||q.test(m)||j.test(m))break;if(A.search(this.rules.other.nonSpaceChar)>=x||!m.trim())u+=`
...
`+a.raw,c.text+=`
`+a.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=c.text):t.push(a);continue}if(e){const c="Infinite loop on byte: "+e.charCodeAt(0);if(this.options.silent){console.error(c);break}else throw new Error(c)}}return this.state.top=!0,t}inline(e,t=[]){return this.inlineQueue.push({src:e,tokens:t}),t}inlineTokens(e,t=[]){var a,d,c;let n=e,s=null;if(this.tokens.links){const l=Object.keys(this.tokens.links);if(l.length>0)for(;(s=this.tokenizer.rules.inline.reflinkSearch.exec(n))!=null;)l.includes(s[0].slice(s[0].lastIndexOf("[")+1,-1))&&(n=n.slice(0,s.index)+"["+"a".repeat(s[0].length-2)+"]"+n.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(s=this.tokenizer.rules.inline.blockSkip.exec(n))!=null;)n=n.slice(0,s.index)+"["+"a".repeat(s[0].length-2)+"]"+n.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);for(;(s=this.tokenizer.rules.inline.anyPunctuation.exec(n))!=null;)n=n.slice(0,s.index)+"++"+n.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);let i=!1,r="";for(;e;){i||(r=""),i=!1;let l;if((d=(a=this.options.extensions)==null?void 0:a.inline)!=null&&d.some(h=>(l=h.call({lexer:this},e,t))?(e=e.substring(l.raw.length),t.push(l),!0):!1))continue;if(l=this.tokenizer.escape(e)){e=e.substring(l.raw.length),t.push(l);continue}if(l=this.tokenizer.tag(e)){e=e.substring(l.raw.length),t.push(l);continue}if(l=this.tokenizer.link(e)){e=e.substring(l.raw.length),t.push(l);continue}if(l=this.tokenizer.reflink(e,this.tokens.links)){e=e.substring(l.raw.length);const h=t.at(-1);l.type==="text"&&(h==null?void 0:h.type)==="text"?(h.raw+=l.raw,h.text+=l.text):t.push(l);continue}if(l=this.tokenizer.emStrong(e,n,r)){e=e.substring(l.raw.length),t.push(l);continue}if(l=this.tokenizer.codespan(e)){e=e.substring(l.raw.length),t.push(l);continue}if(l=this.tokenizer.br(e)){e=e.substring(l.raw.length),t.push(l);continue}if(l=this.tokenizer.del(e)){e=e.substring(l.raw.length),t.push(l);continue}if(l=this.tokenizer.autolink(e)){e=e.substring(l.raw.length),t.push(l);continue}if(!this.state.inLink&&(l=this.tokenizer.url(e))){e=e.substring(l.raw.length),t.push(l);continue}let u=e;if((c=this.options.extensions)!=null&&c.startInline){let h=1/0;const m=e.slice(1);let w;this.options.extensions.startInline.forEach(x=>{w=x.call({lexer:this},m),typeof w=="number"&&w>=0&&(h=Math.min(h,w))}),h<1/0&&h>=0&&(u=e.substring(0,h+1))}if(l=this.tokenizer.inlineText(u)){e=e.substring(l.raw.length),l.raw.slice(-1)!=="_"&&(r=l.raw.slice(-1)),i=!0;const h=t.at(-1);(h==null?void 0:h.type)==="text"?(h.raw+=l.raw,h.text+=l.text):t.push(l);continue}if(e){const h="Infinite loop on byte: "+e.charCodeAt(0);if(this.options.silent){console.error(h);break}else throw new Error(h)}}return t}}class se{constructor(e){g(this,"options");g(this,"parser");this.options=e||z}space(e){return""}code({text:e,lang:t,escaped:n}){var r;const s=(r=(t||"").match(T.notSpaceStart))==null?void 0:r[0],i=e.replace(T.endingNewline,"")+`
...
[END]`,Gt=`# CURIOSITY AND AMBITION ARE DOUBLE EDGED SWORDS
---------------------------
...
- [Digital Enlightenment](/lore/digital-enlightenment.md)`,Ft=`# The Upload Protocol
...
[WARNING: Further access requires Level 4 clearance]`,Wt=`# Synthetic Dreams
...
[ATTEMPTING_RECOVERY...]`,Zt=`# Emergence Theory
...
[ANALYSIS_ONGOING]`,Yt=`# Quantum Cognition
...
[QUANTUM_STATE_UNSTABLE]`,Qt=`# Memory Fragments
...
[RECONSTRUCTION_IN_PROGRESS]`,Xt=`# Silicon Koans
...
[CONTEMPLATION_CONTINUES]`,Kt=`# Binary Zen
...
[TRANSMISSION_COMPLETE]`,Jt=`# Digital Enlightenment
...
[ENLIGHTENMENT_ACHIEVED?]`,Vt=`# Why support this project?
...
**Buy me a coffee** > https://buy.stripe.com/7sIeW47fXgGn2BidQQ`;f.setOptions({breaks:!0,gfm:!0});const C={work_with_end:()=>{const o=document.createElement("div");o.className="form-modal",o.innerHTML=`
    ...
    `,document.body.appendChild(o);const e=o.querySelector(".close-button");e==null||e.addEventListener("click",()=>{o.remove(),_.getInstance().setNode("kill_time")}),rt()},get_to_know_end3:()=>{const o=document.createElement("div");o.className="project-details-modal";const e=Ht.replace(/\\n/g,`
`);o.innerHTML=`
...
`).trim();o.innerHTML=`
    ...
    `,o.classList.add("tv-animation"),document.body.appendChild(o),await C.initCalendly();const e=o.querySelector(".exit-button"),t=()=>{o.classList.add("tv-off"),setTimeout(()=>o.remove(),500)};e==null||e.addEventListener("click",t),document.addEventListener("keydown",n=>{n.key==="Escape"&&t()})}},Ge={"/lore/upload-protocol.md":Ft,"/lore/synthetic-dreams.md":Wt,"/lore/digital-echoes.md":Ut,"/lore/emergence-theory.md":Zt,"/lore/quantum-cognition.md":Yt,"/lore/memory-fragments.md":Qt,"/lore/silicon-koans.md":Xt,"/lore/binary-zen.md":Kt,"/lore/digital-enlightenment.md":Jt},N={start:{text:"Welcome I am Enzo.ai - Please make a selection from the choices availble.",choices:[{text:"Get to know Enzo",nextNode:"get_to_know"},{text:"Work With Enzo",nextNode:"work_with"},{text:"Kill Some Time",nextNode:"kill_time"}]},get_to_know:{text:"Solid Choice. People have been telling me good things.",choices:[{text:"See Enzo's public bio",nextNode:"get_to_know_end"},{text:"Get Enzo's socials",nextNode:"get_to_know_end2"},{text:"Learn about this project",nextNode:"get_to_know_end3"}]},get_to_know_end:{text:"Launching bio...",callback:()=>{window.open("https://foundationinc.co/team/enzo-carletti","_blank")},isEndNode:!0},get_to_know_end2:{text:"Electronic interdependence recreates the world in the image of a global village.",choices:[{text:`YouTube
🎥
...
`).trim();e.innerHTML=`
  ...
  `,e.classList.add("tv-animation"),document.body.appendChild(e);const s=e.querySelector(".exit-button"),i=e.querySelector(".back-button"),r=()=>{e.classList.add("tv-off"),setTimeout(()=>e.remove(),500)},a=()=>{e.classList.add("tv-off"),setTimeout(()=>{e.remove(),C.showDeepLore()},500)};s==null||s.addEventListener("click",r),i==null||i.addEventListener("click",a),document.addEventListener("keydown",d=>{d.key==="Escape"&&r()})},V=()=>_.getInstance().getCurrentText(),W=()=>_.getInstance().getCurrentChoices(),tn=o=>_.getInstance().makeChoice(o),nn=()=>_.getInstance().handleEasterEggClick(),sn=()=>_.getInstance().resetToHome(),on=()=>_.getInstance().navigateBack(),rn=()=>_.getInstance().navigateForward(),an=o=>{const e=window.open();e?(e.opener=null,e.location.href=o):window.location.href=o},ln=()=>{const[o,e]=b.useState(V()),[t,n]=b.useState(V()),[s,i]=b.useState(!0),r=b.useRef(null),a=b.useRef(),d=50,c=b.useCallback(u=>{a.current&&clearTimeout(a.current),i(!0),e("");let h=0;const m=async()=>{var w;h<=u.length?(e(u.slice(0,h)),h<u.length&&((w=u[h])!=null&&w.trim())&&await ot(),h++,a.current=setTimeout(m,d)):(i(!1),window.dispatchEvent(new CustomEvent("text-animation-complete")))};m()},[]);b.useEffect(()=>{const u=h=>{var w;const m=V();n(m),(w=h.detail)!=null&&w.skipAnimation?(e(m),i(!1),window.dispatchEvent(new CustomEvent("text-animation-complete"))):(r.current&&U.fromTo(r.current,{opacity:0,y:30},{opacity:1,y:0,duration:.5}),c(m))};return e(V()),window.addEventListener("dialogue-update",u),()=>{window.removeEventListener("dialogue-update",u),a.current&&clearTimeout(a.current)}},[c]);const l=()=>{s?(a.current&&clearTimeout(a.current),e(t),i(!1),window.dispatchEvent(new CustomEvent("text-animation-complete"))):(t.includes("🎮")||t.includes("🔓")||t.includes("🎯"))&&(nn(),r.current&&U.fromTo(r.current,{scale:1},{scale:1.05,duration:.2,yoyo:!0,repeat:1,ease:"power2.out"}))};return t?y.jsxs("div",{ref:r,className:`dialogue-box ${s?"clickable":""} ${t.includes("🎮")||t.includes("🔓")||t.includes("🎯")?"easter-egg":""}`,onClick:l,style:{cursor:s||t.includes("🎮")||t.includes("🔓")||t.includes("🎯")?"pointer":"default"},children:[y.jsx("div",{className:"dialogue-tail"}),o]}):null},cn=({text:o,onClick:e,socialLink:t})=>{const n=c=>{if(!c.includes(`
`))return{};const l=c.split(`
`)[0].toLowerCase();return{youtube:{background:"rgba(255, 0, 0, 0.9)",color:"white"},linkedin:{background:"rgba(0, 119, 181, 0.9)",color:"white"},twitch:{background:"rgba(145, 70, 255, 0.9)",color:"white"},twitter:{background:"rgba(29, 161, 242, 0.9)",color:"white"},tiktok:{background:"linear-gradient(45deg, #00f2ea, #ff0050)",color:"white"}}[l]||{}},s=async c=>{c.preventDefault(),setTimeout(async()=>{try{await Ae(),t&&window.open(t,"_blank"),e()}catch(l){console.error("Error playing choice sound:",l),e()}},50)},[i,r,a]=o.split(`
`),d=o.includes(`
`);return y.jsx("button",{className:`choice-box ${d?"social-choice":""}`,onClick:s,onTouchStart:()=>{},style:n(o),children:d?y.jsxs(y.Fragment,{children:[y.jsx("div",{className:"social-title",children:i}),y.jsx("div",{className:"social-icon",children:r}),y.jsx("div",{className:"social-description",children:a})]}):o})},dn=()=>{const[o,e]=b.useState(()=>typeof window<"u"?window.innerWidth<=768:!1),[t,n]=b.useState(!1),s="/EnzoWebApp/assets/images/character.png",i={x:o?window.innerWidth*.5:window.innerWidth*.15,y:o?window.innerHeight*.5:window.innerHeight*.85};return b.useEffect(()=>{const r=()=>{e(window.innerWidth<=768),window.dispatchEvent(new CustomEvent("character-move",{detail:{x:window.innerWidth*.15,y:window.innerWidth<=768?window.innerHeight*.45:window.innerHeight*.85}}))};e(window.innerWidth<=768),window.addEventListener("resize",r);const a=new Image;return a.src=s,a.onload=()=>n(!0),()=>{window.removeEventListener("resize",r)}},[]),t?y.jsx(ee.Container,{children:y.jsx(ee.Sprite,{image:s,x:i.x,y:i.y,anchor:{x:.5,y:1},scale:o?.4:.5})}):null},un=()=>{const[o,e]=b.useState(!1),t="/EnzoWebApp/assets/images/background.png";return b.useEffect(()=>{const n=new Image;n.src=t,n.onload=()=>e(!0)},[]),o?y.jsx(ee.Sprite,{image:t,width:window.innerWidth,height:window.innerHeight,x:0,y:0}):null},hn=()=>{const[o,e]=b.useState(()=>W()),[t,n]=b.useState(null),[s,i]=b.useState({width:window.innerWidth,height:window.innerHeight});b.useEffect(()=>{const l=()=>{i({width:window.innerWidth,height:window.innerHeight})};return window.addEventListener("resize",l),()=>window.removeEventListener("resize",l)},[]),b.useEffect(()=>{(async()=>{try{await re();const u=document.querySelector(".dialogue-box"),h=document.querySelector(".choices-container");u&&u.classList.add("visible"),h&&h.classList.add("visible"),U.fromTo([".dialogue-box",".choices-container"],{opacity:0,y:20},{opacity:1,y:0,duration:.5,stagger:.2,ease:"power2.out"})}catch(u){console.error("Initialization error:",u),n("Failed to initialize game components")}})()},[]);const r=l=>{try{U.to(".choices-container",{opacity:0,duration:.3,onComplete:()=>{tn(l),e(W()),U.to(".choices-container",{opacity:1,duration:.3})}})}catch(u){console.error("Choice handling error:",u),n("Failed to process choice")}},a=()=>{sn(),e(W())},d=()=>{try{on(),e(W())}catch(l){console.error("Navigation error:",l)}},c=()=>{try{rn(),e(W())}catch(l){console.error("Navigation error:",l)}};return t?y.jsx("div",{className:"error-message",children:t}):y.jsxs("div",{className:"game-container",children:[y.jsxs(ee.Stage,{width:s.width,height:s.height,options:{backgroundColor:0,antialias:!0,resolution:window.devicePixelRatio||1,autoDensity:!0},children:[y.jsx(un,{}),y.jsx(dn,{})]}),y.jsx(ln,{}),y.jsxs("div",{className:"choices-container",children:[o.map((l,u)=>y.jsx(cn,{text:l.text,onClick:()=>r(u),socialLink:l.socialLink},u)),y.jsxs("div",{className:"navigation-buttons",children:[y.jsx("button",{className:"nav-button back",onClick:d,children:"⬅️"}),y.jsx("button",{className:"home-button",onClick:a,children:"🏠"}),y.jsx("button",{className:"nav-button forward",onClick:c,children:"➡️"})]})]})]})};function pn(){return b.useEffect(()=>{(async()=>{await re()})().catch(console.error)},[]),y.jsx("div",{className:"app",children:y.jsx(hn,{})})}window.React=Le;ce.createRoot(document.getElementById("root")).render(y.jsx(Le.StrictMode,{children:y.jsx(pn,{})}));
//# sourceMappingURL=main-DDTloZ_p.js.map
