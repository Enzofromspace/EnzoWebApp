var Ye=Object.defineProperty;var Qe=(o,e,t)=>e in o?Ye(o,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):o[e]=t;var g=(o,e,t)=>Qe(o,typeof e!="symbol"?e+"":e,t);import{r as b,b as Xe,R as Re}from"./react-CHYZsP8B.js";import{m as V}from"./pixi-YXKqUbkg.js";import{c as Ke,s as he,F as Je,S as Ve,n as _e}from"./tone-BHsarVZ3.js";import{g as U}from"./gsap-DjKJqAo0.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function t(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(s){if(s.ep)return;s.ep=!0;const i=t(s);fetch(s.href,i)}})();var Ae={exports:{}},se={};/**
 * @license React
...
`,e=e.substring(m.length+1),c=!0),!c){const q=this.rules.other.nextBulletRegex(x),j=this.rules.other.hrRegex(x),D=this.rules.other.fencesBeginRegex(x),B=this.rules.other.headingBeginRegex(x),$=this.rules.other.htmlBeginRegex(x);for(;e;){const O=e.split(`
...
`):[],r={type:"table",raw:t[0],header:[],align:[],rows:[]};if(n.length===s.length){for(const d of s)this.rules.other.tableAlignRight.test(d)?r.align.push("right"):this.rules.other.tableAlignCenter.test(d)?r.align.push("center"):this.rules.other.tableAlignLeft.test(d)?r.align.push("left"):r.align.push(null);for(let d=0;d<n.length;d++)r.header.push({text:n[d],tokens:this.lexer.inline(n[d]),header:!0,align:r.align[d]});for(const d of i)r.rows.push(Le(d,r.header.length).map((c,l)=>({text:c,tokens:this.lexer.inline(c),header:!1,align:r.align[l]})));return r}}lheading(e){const t=this.rules.block.lheading.exec(e);if(t)return{type:"heading",raw:t[0],depth:t[2].charAt(0)==="="?1:2,text:t[1],tokens:this.lexer.inline(t[1])}}paragraph(e){const t=this.rules.block.paragraph.exec(e);if(t){const n=t[1].charAt(t[1].length-1)===`
...
`+a.raw,c.text+=`
`+a.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=c.text):t.push(a);continue}if(e){const c="Infinite loop on byte: "+e.charCodeAt(0);if(this.options.silent){console.error(c);break}else throw new Error(c)}}return this.state.top=!0,t}inline(e,t=[]){return this.inlineQueue.push({src:e,tokens:t}),t}inlineTokens(e,t=[]){var a,d,c;let n=e,s=null;if(this.tokens.links){const l=Object.keys(this.tokens.links);if(l.length>0)for(;(s=this.tokenizer.rules.inline.reflinkSearch.exec(n))!=null;)l.includes(s[0].slice(s[0].lastIndexOf("[")+1,-1))&&(n=n.slice(0,s.index)+"["+"a".repeat(s[0].length-2)+"]"+n.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(s=this.tokenizer.rules.inline.blockSkip.exec(n))!=null;)n=n.slice(0,s.index)+"["+"a".repeat(s[0].length-2)+"]"+n.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);for(;(s=this.tokenizer.rules.inline.anyPunctuation.exec(n))!=null;)n=n.slice(0,s.index)+"++"+n.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);let i=!1,r="";for(;e;){i||(r=""),i=!1;let l;if((d=(a=this.options.extensions)==null?void 0:a.inline)!=null&&d.some(h=>(l=h.call({lexer:this},e,t))?(e=e.substring(l.raw.length),t.push(l),!0):!1))continue;if(l=this.tokenizer.escape(e)){e=e.substring(l.raw.length),t.push(l);continue}if(l=this.tokenizer.tag(e)){e=e.substring(l.raw.length),t.push(l);continue}if(l=this.tokenizer.link(e)){e=e.substring(l.raw.length),t.push(l);continue}if(l=this.tokenizer.reflink(e,this.tokens.links)){e=e.substring(l.raw.length);const h=t.at(-1);l.type==="text"&&(h==null?void 0:h.type)==="text"?(h.raw+=l.raw,h.text+=l.text):t.push(l);continue}if(l=this.tokenizer.emStrong(e,n,r)){e=e.substring(l.raw.length),t.push(l);continue}if(l=this.tokenizer.codespan(e)){e=e.substring(l.raw.length),t.push(l);continue}if(l=this.tokenizer.br(e)){e=e.substring(l.raw.length),t.push(l);continue}if(l=this.tokenizer.del(e)){e=e.substring(l.raw.length),t.push(l);continue}if(l=this.tokenizer.autolink(e)){e=e.substring(l.raw.length),t.push(l);continue}if(!this.state.inLink&&(l=this.tokenizer.url(e))){e=e.substring(l.raw.length),t.push(l);continue}let u=e;if((c=this.options.extensions)!=null&&c.startInline){let h=1/0;const m=e.slice(1);let w;this.options.extensions.startInline.forEach(x=>{w=x.call({lexer:this},m),typeof w=="number"&&w>=0&&(h=Math.min(h,w))}),h<1/0&&h>=0&&(u=e.substring(0,h+1))}if(l=this.tokenizer.inlineText(u)){e=e.substring(l.raw.length),l.raw.slice(-1)!=="_"&&(r=l.raw.slice(-1)),i=!0;const h=t.at(-1);(h==null?void 0:h.type)==="text"?(h.raw+=l.raw,h.text+=l.text):t.push(l);continue}if(e){const h="Infinite loop on byte: "+e.charCodeAt(0);if(this.options.silent){console.error(h);break}else throw new Error(h)}}return t}}class ie{constructor(e){g(this,"options");g(this,"parser");this.options=e||z}space(e){return""}code({text:e,lang:t,escaped:n}){var r;const s=(r=(t||"").match(v.notSpaceStart))==null?void 0:r[0],i=e.replace(v.endingNewline,"")+`
...
`).trim();e.innerHTML=`
  ...
  `,e.classList.add("tv-animation"),document.body.appendChild(e);const s=e.querySelector(".exit-button"),i=e.querySelector(".back-button"),r=()=>{e.classList.add("tv-off"),setTimeout(()=>e.remove(),500)},a=()=>{e.classList.add("tv-off"),setTimeout(()=>{e.remove(),C.showDeepLore()},500)};s==null||s.addEventListener("click",r),i==null||i.addEventListener("click",a),document.addEventListener("keydown",d=>{d.key==="Escape"&&r()})},J=()=>_.getInstance().getCurrentText(),W=()=>_.getInstance().getCurrentChoices(),sn=o=>_.getInstance().makeChoice(o),on=()=>_.getInstance().handleEasterEggClick(),rn=()=>_.getInstance().resetToHome(),an=()=>_.getInstance().navigateBack(),ln=()=>_.getInstance().navigateForward(),cn=o=>{const e=window.open();e?(e.opener=null,e.location.href=o):window.location.href=o},dn=()=>{const[o,e]=b.useState(J()),[t,n]=b.useState(J()),[s,i]=b.useState(!0),r=b.useRef(null),a=b.useRef(),d=50,c=b.useCallback(u=>{a.current&&clearTimeout(a.current),i(!0),e("");let h=0;const m=async()=>{var w;h<=u.length?(e(u.slice(0,h)),h<u.length&&((w=u[h])!=null&&w.trim())&&await at(),h++,a.current=setTimeout(m,d)):(i(!1),window.dispatchEvent(new CustomEvent("text-animation-complete")))};m()},[]);b.useEffect(()=>{const u=h=>{var w;const m=J();n(m),(w=h.detail)!=null&&w.skipAnimation?(e(m),i(!1),window.dispatchEvent(new CustomEvent("text-animation-complete"))):(r.current&&U.fromTo(r.current,{opacity:0,y:30},{opacity:1,y:0,duration:.5}),c(m))};return e(J()),window.addEventListener("dialogue-update",u),()=>{window.removeEventListener("dialogue-update",u),a.current&&clearTimeout(a.current)}},[c]);const l=()=>{s?(a.current&&clearTimeout(a.current),e(t),i(!1),window.dispatchEvent(new CustomEvent("text-animation-complete"))):(t.includes("🎮")||t.includes("🔓")||t.includes("🎯"))&&(on(),r.current&&U.fromTo(r.current,{scale:1},{scale:1.05,duration:.2,yoyo:!0,repeat:1,ease:"power2.out"}))};return t?y.jsxs("div",{ref:r,className:`dialogue-box ${s?"clickable":""} ${t.includes("🎮")||t.includes("🔓")||t.includes("🎯")?"easter-egg":""}`,onClick:l,style:{cursor:s||t.includes("🎮")||t.includes("🔓")||t.includes("🎯")?"pointer":"default"},children:[y.jsx("div",{className:"dialogue-tail"}),o]}):null},un=({text:o,onClick:e,socialLink:t})=>{const n=c=>{if(!c.includes(`
`))return{};const l=c.split(`
`)[0].toLowerCase();return{youtube:{background:"rgba(255, 0, 0, 0.9)",color:"white"},linkedin:{background:"rgba(0, 119, 181, 0.9)",color:"white"},twitch:{background:"rgba(145, 70, 255, 0.9)",color:"white"},twitter:{background:"rgba(29, 161, 242, 0.9)",color:"white"},tiktok:{background:"linear-gradient(45deg, #00f2ea, #ff0050)",color:"white"}}[l]||{}},s=async c=>{c.preventDefault();try{if(await $e(),e(),t){const l=document.createElement("a");l.href=t,l.target="_blank",l.rel="noopener noreferrer",setTimeout(()=>{document.body.appendChild(l),l.click(),document.body.removeChild(l)},100)}}catch(l){console.error("Error in click handler:",l),e()}},[i,r,a]=o.split(`
`),d=o.includes(`
`);return y.jsx("button",{className:`choice-box ${d?"social-choice":""}`,onClick:s,onTouchStart:()=>{},style:n(o),children:d?y.jsxs(y.Fragment,{children:[y.jsx("div",{className:"social-title",children:i}),y.jsx("div",{className:"social-icon",children:r}),y.jsx("div",{className:"social-description",children:a})]}):o})},hn=()=>{const[o,e]=b.useState(()=>typeof window<"u"?window.innerWidth<=768:!1),[t,n]=b.useState(!1),s="/EnzoWebApp/assets/images/character.png",i={x:o?window.innerWidth*.5:window.innerWidth*.15,y:o?window.innerHeight*.5:window.innerHeight*.85};return b.useEffect(()=>{const r=()=>{e(window.innerWidth<=768),window.dispatchEvent(new CustomEvent("character-move",{detail:{x:window.innerWidth*.15,y:window.innerWidth<=768?window.innerHeight*.45:window.innerHeight*.85}}))};e(window.innerWidth<=768),window.addEventListener("resize",r);const a=new Image;return a.src=s,a.onload=()=>n(!0),()=>{window.removeEventListener("resize",r)}},[]),t?y.jsx(V.Container,{children:y.jsx(V.Sprite,{image:s,x:i.x,y:i.y,anchor:{x:.5,y:1},scale:o?.4:.5})}):null},pn=()=>{const[o,e]=b.useState(!1),t="/EnzoWebApp/assets/images/background.png";return b.useEffect(()=>{const n=new Image;n.src=t,n.onload=()=>e(!0)},[]),o?y.jsx(V.Sprite,{image:t,width:window.innerWidth,height:window.innerHeight,x:0,y:0}):null},mn=()=>{const[o,e]=b.useState(()=>W()),[t,n]=b.useState(null),[s,i]=b.useState({width:window.innerWidth,height:window.innerHeight});b.useEffect(()=>{const l=()=>{i({width:window.innerWidth,height:window.innerHeight})};return window.addEventListener("resize",l),()=>window.removeEventListener("resize",l)},[]),b.useEffect(()=>{(async()=>{try{await oe();const u=document.querySelector(".dialogue-box"),h=document.querySelector(".choices-container");u&&u.classList.add("visible"),h&&h.classList.add("visible"),U.fromTo([".dialogue-box",".choices-container"],{opacity:0,y:20},{opacity:1,y:0,duration:.5,stagger:.2,ease:"power2.out"})}catch(u){console.error("Initialization error:",u),n("Failed to initialize game components")}})()},[]);const r=l=>{try{U.to(".choices-container",{opacity:0,duration:.3,onComplete:()=>{sn(l),e(W()),U.to(".choices-container",{opacity:1,duration:.3})}})}catch(u){console.error("Choice handling error:",u),n("Failed to process choice")}},a=()=>{rn(),e(W())},d=()=>{try{an(),e(W())}catch(l){console.error("Navigation error:",l)}},c=()=>{try{ln(),e(W())}catch(l){console.error("Navigation error:",l)}};return t?y.jsx("div",{className:"error-message",children:t}):y.jsxs("div",{className:"game-container",children:[y.jsxs(V.Stage,{width:s.width,height:s.height,options:{backgroundColor:0,antialias:!0,resolution:window.devicePixelRatio||1,autoDensity:!0},children:[y.jsx(pn,{}),y.jsx(hn,{})]}),y.jsx(dn,{}),y.jsxs("div",{className:"choices-container",children:[o.map((l,u)=>y.jsx(un,{text:l.text,onClick:()=>r(u),socialLink:l.socialLink},u)),y.jsxs("div",{className:"navigation-buttons",children:[y.jsx("button",{className:"nav-button back",onClick:d,children:"⬅️"}),y.jsx("button",{className:"home-button",onClick:a,children:"🏠"}),y.jsx("button",{className:"nav-button forward",onClick:c,children:"➡️"})]})]})]})};function gn(){return b.useEffect(()=>{(async()=>{await oe()})().catch(console.error)},[]),y.jsx("div",{className:"app",children:y.jsx(mn,{})})}window.React=Re;de.createRoot(document.getElementById("root")).render(y.jsx(Re.StrictMode,{children:y.jsx(gn,{})}));
//# sourceMappingURL=main-DjMtCGzx.js.map
